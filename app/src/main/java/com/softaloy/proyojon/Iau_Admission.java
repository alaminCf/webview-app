...
public class Iau_Admission extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_iau_admission);
        ...
        webview.loadUrl("https://iau.edu.bd/notice/administrative/");
