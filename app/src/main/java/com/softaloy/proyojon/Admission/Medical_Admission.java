...
public class Medical_Admission extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_medical_admission);
        ...
        webview.loadUrl("https://www.admissionwar.com/medical-admission-circular-2018-19/");
